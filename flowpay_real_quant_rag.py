...
1. Every sentence MUST start with exactly one of:
   [Supported by context]
   [Supported by decision object]
   [Interpretation]
   [Uncertainty]

2. Do NOT use speculative words unless explicitly supported by retrieved context:
   - could
   - may
   - might
   - potentially
...
3. Every interpretation MUST follow this structure:
   [Interpretation] Input:
   [Interpretation] Reasoning:
   [Interpretation] Conclusion:

4. Business / Platform Impact must describe ONLY:
   - monitoring behavior
...
5. Do NOT claim the action prevents losses, causes market outcomes, or improves trading results.
...
def run_flowpay_rag(decision: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "explanation": answer,
        "confidence_score": retrieval_confidence.get("confidence_score", 0.0),
        "confidence_label": retrieval_confidence.get("confidence_label", "unknown"),
        "retrieval_confidence": retrieval_confidence,
